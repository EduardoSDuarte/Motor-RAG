#!/bin/bash
# Motor RAG Jurídico — Script de execução completa
# Uso: bash run.sh

echo "========================================"
echo " Motor RAG Jurídico — Projeto 1"
echo "========================================"
